<footer class="section-t-space mt-3">
  <div class="container-fluid-lg">
    ...
    <div class="colorlib-partner" style="margin-bottom: 50px;">
			<div class="container">
				<div class="row">
					<div class="col partner-col text-center">
						<img src="../../../resources/images/footer/brand-1.jpeg" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="../../../resources/images/footer/brand-2.jpeg" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="../../../resources/images/footer/brand-3.jpeg" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="../../../resources/images/footer/brand-4.jpeg" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
						<img src="../../../resources/images/footer/brand-5.jpeg" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
				</div>
			</div>
		</div>
      ...
      <div class="row g-md-4 g-3">
            ...
            <div class="footer-logo-contain">
              <ul class="address">
                <li>
                  ...
                  <a href="javascript:void(0)">Hoà Hải, Ngũ Hành Sơn, Đà Nẵng</a>
                </li>
                <li>
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="footer-contain">
            <ul>
              <li>
                <a href="/categories?search=Iphone" class="text-content">Nike</a>
              </li>
              <li>
                <a href="/categories?search=Xiaomi" class="text-content">Adidas</a>
              </li>
              <li>
                <a href="/categories?search=Samsung" class="text-content">MLB</a>
              </li>
              <li>
                <a href="/categories?search=Samsung" class="text-content">Puma</a>
              </li>
            </ul>
          </div>
        </div>
